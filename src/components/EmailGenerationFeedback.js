    ...
    return (
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl border border-white/20 p-8 max-w-md mx-4 text-center">
          ...
          <p className="text-purple-200">Your feedback helps us improve EmailCraft for everyone!</p>
        </div>
      </div>
    );
  }
          ...
          {currentStep === 1 && (
            <div className="space-y-6 text-center">
              <div className="mb-6">
                ...
                <p className="text-purple-200">How would you rate your overall experience with EmailCraft?</p>
              </div>
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-white font-medium mb-3">Would you recommend EmailCraft?</label>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Share your ideas for making EmailCraft even better..."
                    rows={4}
                    className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-purple-200 focus:outline-none focus:ring-2 focus:ring-purple-400"
                  />
                </div>
